...
class App extends Component {
  ...
  componentDidMount() {
    ...
    if (!this.state.intervalIsSet) {
      let interval = setInterval(this.getDataFromDb, 10000000);
          ...
          {data.length <= 0
            ...
            : data.map(dat => (
                <li style={{ padding: "10px" }} key={data}>
                  ...
                  <span style={{ color: "gray" }}> voiceChannel: </span> {dat.voiceChannel} <br />
                  <span style={{ color: "gray" }}> voiceChannelid: </span> {dat.voiceChannelid} <br />
                  <span style={{ color: "gray" }}> timeJoin: </span> {dat.timeJoin} <br />
                  <span style={{ color: "gray" }}> timeJoin: </span> {dat.timeJoin} <br />
                  <span style={{ color: "gray" }}> guild: </span> {dat.guild} <br />
                  {dat.message}
                </li>
              ))}
        </ul>
